...
export excel using "$out/01_hfc_hh_completion_rate.xlsx", sheet("02_geo") firstrow(varlabels) sheetreplace
restore 
...
export excel using "$out/01_hfc_hh_completion_rate.xlsx", sheet("03_team") firstrow(varlabels) sheetreplace
restore 
...
export excel using "$out/01_hfc_hh_completion_rate.xlsx", sheet("04_enu") firstrow(varlabels) sheetreplace
restore 
