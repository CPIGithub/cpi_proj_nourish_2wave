...
********************************************************************************
	...
	* Check for Missing variable label and variable label 
	//iecodebook template using "$raw/endline/codebook/PN_Village_Endline_FINAL_Constructed_cleaning.xlsx" // export template
	iecodebook apply using "$raw/endline/codebook/PN_Village_Endline_FINAL_Constructed_cleaning.xlsx" 



	* save as labeled var dataset  
	save "$dta/endline/PN_Village_Survey_Endline_FINAL_Constructed.dta", replace  
