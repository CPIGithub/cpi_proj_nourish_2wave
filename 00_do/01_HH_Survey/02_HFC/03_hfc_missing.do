...
foreach grp in `loopgrp' {
	...
	preserve 
		...
		*Adding title table 1
		...
		export excel title using "$out/02_hfc_hh_missing.xlsx", sheet("`grp'") sheetreplace cell(A1) 
		...
		*Adding title table 2
		...
		export excel title using "$out/02_hfc_hh_missing.xlsx", sheet("`grp'") sheetmodify cell(G1) 
