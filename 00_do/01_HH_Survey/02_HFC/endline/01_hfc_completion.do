...
Purpose				:	Endline data collection: completion check 			
...
*******************************************************************************/
	...
	** HH Survey Dataset **
	...
	// stratum 
	gen st_target_N = (14 * 15) if stratum == 1 
	replace st_target_N = (14 * 30) if stratum == 2
	...
	replace  org_st_target_N = (7 * 14) 	if stratum == 1 & org_name == "KDHW"
	...
	export excel using "$out/endline/01_hfc_hh_completion_rate.xlsx", sheet("01_overall") firstrow(varlabels) keepcellfmt sheetreplace
	restore 
	...
	export excel using "$out/endline/01_hfc_hh_completion_rate.xlsx", sheet("01_overall") firstrow(varlabels) cell(A10) keepcellfmt sheetmodify
	...
	export excel using "$out/endline/01_hfc_hh_completion_rate.xlsx", sheet("01_overall") firstrow(varlabels) cell(A19) keepcellfmt sheetmodify
	...
	export excel using "$out/endline/01_hfc_hh_completion_rate.xlsx", sheet("02_org") firstrow(varlabels) keepcellfmt sheetreplace
	restore 
	...
	export excel using "$out/endline/01_hfc_hh_completion_rate.xlsx", sheet("03_geo") firstrow(varlabels) keepcellfmt sheetreplace
	restore 
	...
	export excel using "$out/endline/01_hfc_hh_completion_rate.xlsx", sheet("04_team") firstrow(varlabels) keepcellfmt sheetreplace
	restore 
	...
	export excel using "$out/endline/01_hfc_hh_completion_rate.xlsx", sheet("05_enu") firstrow(varlabels) keepcellfmt sheetreplace
	restore 
	...
	** replaced villages **
	...
	export excel using "$out/endline/01_hfc_hh_completion_rate.xlsx", sheet("06_replaced_villages") firstrow(varlabels) keepcellfmt sheetreplace
	restore 
