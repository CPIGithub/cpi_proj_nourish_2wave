...
Purpose				:	Endline data collection: child health data cleaning 			
...
do "$do/00_dir_setting.do"
	...
	* Child Health Data *
	****************************************************************************
	use "$dta/endline/pnourish_child_health_raw.dta", clear 
	...
	** SAVE for analysis dataset 
	save "$dta/endline/pnourish_child_health_final.dta", replace  
