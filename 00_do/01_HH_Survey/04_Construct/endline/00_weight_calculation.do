...
Purpose				:	Endline data collection: HH survey weight calculation 			
...
order	org_name township_name geo_town ///
		...
		vill_accessibility_midterm vill_proj_implement_midterm ///
		stratum_midterm 
...
export excel using "$result/endline/pn_endline_survey_weight.xlsx", sheet("weight") firstrow(variable)  nolabel replace 

save "$dta/endline/pnourish_endline_hh_weight_final.dta", replace  
