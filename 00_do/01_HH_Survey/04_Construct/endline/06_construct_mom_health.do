...
Purpose				:	Endline data collection: Mom Health data cleaning 			
...
do "$do/00_dir_setting.do"
	...
	* Mom Health Module *
	****************************************************************************
	use "$dta/endline/pnourish_mom_health_raw.dta", clear 
	
	/* 
	Note: iycf module has 279 U2 children but Mom ANC/PNC has 206 U2 mom
	27 obs discripency 
	result from that some children were not present at home during data collection 
	*/
	...
	** SAVE for analysis dataset 
	save "$dta/endline/pnourish_mom_health_final.dta", replace  
