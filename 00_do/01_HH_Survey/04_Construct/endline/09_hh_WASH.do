...
Purpose				:	Endline data collection: hh WASH data cleaning 			
...
********************************************************************************
	...
	*/
	...
	gen hw_critical_soap 	= (	soap_tiolet == 4 & ///
								soap_child_faeces == 4 & ///
								soap_before_eat == 4 & ///
								soap_before_cook == 4 & ///
								soap_feed_child == 4)
	...
	lab var hw_critical_soap "Handwashing with soap always at 5 critical times (NCBI)"
	...
	*/
	...
	gen hw_critical_soap_prg 	= (	soap_before_cook == 4 & ///
									soap_before_eat == 4 & soap_after_eat == 4 & ///
									soap_feed_child == 4 & ///
									soap_tiolet == 4 & ///
									soap_child_faeces == 4)
	replace hw_critical_soap_prg = .m if 	mi(soap_before_cook) | mi(soap_before_eat) | ///
											mi(soap_after_eat) | mi(soap_feed_child) | ///
											mi(soap_tiolet) | mi(soap_child_faeces)
	tab hw_critical_soap_prg, m 
	lab var hw_critical_soap_prg "Handwashing with soap always at 5 critical times (Program Team def)"
	...
	** SAVE for analysis dataset 
	save "$dta/endline/pnourish_WASH_final.dta", replace  
