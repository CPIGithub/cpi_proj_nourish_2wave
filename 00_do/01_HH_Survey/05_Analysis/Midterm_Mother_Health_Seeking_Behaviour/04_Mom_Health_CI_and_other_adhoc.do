	...
	* Correlation matrix for the Multivar ranking val 
	global outcomes anc_yn anc_who_trained anc_visit_trained_4times ///
					insti_birth skilled_battend ///
					pnc_yn pnc_who_trained nbc_yn nbc_who_trained
	...
	foreach var of global outcomes {
		...
		svy: logit `var' $all_unfiar 
		
		predict `var'_pdt, pr
		
	}
	
	cor anc_yn_pdt anc_who_trained_pdt anc_visit_trained_4times_pdt insti_birth_pdt skilled_battend_pdt pnc_yn_pdt pnc_who_trained_pdt nbc_yn_pdt nbc_who_trained_pdt
