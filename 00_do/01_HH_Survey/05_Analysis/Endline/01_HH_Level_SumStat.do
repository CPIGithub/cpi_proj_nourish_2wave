...
do "$do/00_dir_setting.do"
	...
	* var label 
	lab var d4_inc_status 			"Average monthly income (last month)"
	...
	* create a dummy var 
	...
	d4_inc_status income_lastmonth_trim d7_inc_govngo 
	
	jan_incom_status thistime_incom_status 
	
	global outcomes d3_inc_lmth income_lastmonth_trim  ///
					xxx
